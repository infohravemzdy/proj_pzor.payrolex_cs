...
{
    public class ServiceTestExamples2019 : ServiceTestExampleTemplate
    {
        private static IPeriod TestPeriod = new Period(2019,1);
        private static Int32 TestPeriodCode = 201901;
        private static Int32 PrevPeriodCode = 201801;

        public static IEnumerable<object[]> GenTestData => GetGenTestDecData(_genTests, TestPeriod, TestPeriodCode, PrevPeriodCode);

        public ServiceTestExamples2019(ITestOutputHelper output) : base(output)
        {
        }
        [Fact]
