...
{
    public class ServiceTestExamples2014 : ServiceTestExampleTemplate
    {
        private static IPeriod TestPeriod = new Period(2014,1);
        private static Int32 TestPeriodCode = 201401;
        private static Int32 PrevPeriodCode = 201301;

        public static IEnumerable<object[]> GenTestData => GetGenTestDecData(_genTests, TestPeriod, TestPeriodCode, PrevPeriodCode);

        public ServiceTestExamples2014(ITestOutputHelper output) : base(output)
        {
        }
        [Fact]
