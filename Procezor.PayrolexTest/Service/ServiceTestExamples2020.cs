...
{
    public class ServiceTestExamples2020 : ServiceTestExampleTemplate
    {
        private static IPeriod TestPeriod = new Period(2020,1);
        private static Int32 TestPeriodCode = 202001;
        private static Int32 PrevPeriodCode = 201901;

        public static IEnumerable<object[]> GenTestData => GetGenTestDecData(_genTests, TestPeriod, TestPeriodCode, PrevPeriodCode);

        public ServiceTestExamples2020(ITestOutputHelper output) : base(output)
        {
        }
        [Fact]
