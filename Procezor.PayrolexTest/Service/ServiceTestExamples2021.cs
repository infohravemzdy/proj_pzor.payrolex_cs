...
{
    public class ServiceTestExamples2021 : ServiceTestExampleTemplate
    {
        private static IPeriod TestPeriod = new Period(2021,1);
        private static Int32 TestPeriodCode = 202101;
        private static Int32 PrevPeriodCode = 202001;

        public static IEnumerable<object[]> GenTestData => GetGenTestDecData(_genTests, TestPeriod, TestPeriodCode, PrevPeriodCode);

        public ServiceTestExamples2021(ITestOutputHelper output) : base(output)
        {
        }
        [Fact]
