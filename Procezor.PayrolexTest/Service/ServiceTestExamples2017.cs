...
{
    public class ServiceTestExamples2017 : ServiceTestExampleTemplate
    {
        private static IPeriod TestPeriod = new Period(2017,1);
        private static Int32 TestPeriodCode = 201701;
        private static Int32 PrevPeriodCode = 201601;

        public static IEnumerable<object[]> GenTestData => GetGenTestDecData(_genTests, TestPeriod, TestPeriodCode, PrevPeriodCode);

        public ServiceTestExamples2017(ITestOutputHelper output) : base(output)
        {
        }
        [Fact]
