...
{
    public class ServiceTestExamples2016 : ServiceTestExampleTemplate
    {
        private static IPeriod TestPeriod = new Period(2016,1);
        private static Int32 TestPeriodCode = 201601;
        private static Int32 PrevPeriodCode = 201501;

        public static IEnumerable<object[]> GenTestData => GetGenTestDecData(_genTests, TestPeriod, TestPeriodCode, PrevPeriodCode);

        public ServiceTestExamples2016(ITestOutputHelper output) : base(output)
        {
        }
        [Fact]
