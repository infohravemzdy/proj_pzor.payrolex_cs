...
{
    public class ServiceTestExamples2018 : ServiceTestExampleTemplate
    {
        private static IPeriod TestPeriod = new Period(2018,1);
        private static Int32 TestPeriodCode = 201801;
        private static Int32 PrevPeriodCode = 201701;

        public static IEnumerable<object[]> GenTestData => GetGenTestDecData(_genTests, TestPeriod, TestPeriodCode, PrevPeriodCode);

        public ServiceTestExamples2018(ITestOutputHelper output) : base(output)
        {
        }
        [Fact]
