...
{
    public class ServiceTestExamples2015 : ServiceTestExampleTemplate
    {
        private static IPeriod TestPeriod = new Period(2015,1);
        private static Int32 TestPeriodCode = 201501;
        private static Int32 PrevPeriodCode = 201401;

        public static IEnumerable<object[]> GenTestData => GetGenTestDecData(_genTests, TestPeriod, TestPeriodCode, PrevPeriodCode);

        public ServiceTestExamples2015(ITestOutputHelper output) : base(output)
        {
        }
        [Fact]
